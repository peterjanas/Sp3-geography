...
function HomeIcon() {
  ...
  const hoverStyle = {
    ...
    transform: isHovered ? "scale(1.1) rotate(3deg)" : "scale(1)", // Slight rotation and scaling
    opacity: isHovered ? 0.9 : 1, // Subtle fade
    boxShadow: isHovered ? "0px 4px 15px rgba(0, 0, 0, 0.3)" : "none", // Shadow effect on hover
    backgroundColor: isHovered ? "#2c3e50" : "transparent", // Dark background on hover
    borderRadius: "12px", // Rounded edges for the hover container
    padding: "2px", // Spacing around the SVG
    display: "inline-block", // Ensures padding works around the icon
